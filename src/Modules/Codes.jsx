...
const Codes = () => {
     ...
     const submitCode = ()=> {
        ...
        axios({
            ...
            .then((res) => {
                res.data.results ? setCopyResults(res.data.results) : setCopyResults([]);
                setLoading(false);
                setDialogText("Code Submitted");
                handleOpen();
                setLoading(false);
            })
            .catch((err) => {
            ...
            <div>
                ...
                <Grid container spacing={2} style={{marginTop:"2rem"}}>
                    ...
                    <Grid item xs={8}>
                        {/* result */}
                        {
                            loading? <Box sx={{ display: 'flex' ,justifyContent:"center",height: 400}}>
                            <CircularProgress />
                          </Box> :
                        
                        <Paper>
                            <TableContainer component={Paper} elevation={1} sx={{ height: 400 }}>
